...
<head>
  ...
  <title>Sads Help - المنصة التعليمية الحديثة</title>
...
<body>
  <header>
    ...
    <div class="nav-buttons">
      <button class="nav-btn active" onclick="loadContent('lectures')">
        <i class="fas fa-play-circle"></i>
        المحاضرات
      </button>
      <button class="nav-btn" onclick="loadContent('materials')">
        <i class="fas fa-book"></i>
        الملازم
      </button>
      <button class="nav-btn" onclick="loadContent('exams')">
  ...
  <div id="homePage" class="page active">
    <div class="teachers-section">
      <h2 class="section-title">اختر مدرسك المفضل</h2>
  ...
  <div id="videoPage" class="page">
    <div class="video-page">
      ...
      <div class="video-details">
        ...
        <button class="copy-button" onclick="copyLectureLink()">
          <i class="fas fa-copy"></i>
          نسخ رابط المحاضرة
        </button>
        <button class="back-button" onclick="navigate('classes')">
          <i class="fas fa-arrow-right"></i>
          العودة للفصول
        </button>
      </div>
  ...
  <div id="materialsPage" class="page">
    <div class="materials-section">
      <h2 class="section-title">الملازم الدراسية</h2>
  ...
  <div id="telegramModal" class="modal" style="display: none;">
    <div class="modal-content">
      ...
      <img src="https://cdn.glitch.global/d472cc04-f40d-483a-8a7d-67c6c1ddaaff/Picsart_25-04-18_07-56-03-508.jpg?v=1744952192982" alt="قناة التليجرام">
      <h3>اشترك في قناة التليجرام</h3>
      <p>تابع آخر التحديثات والمحتوى الجديد</p>
      <a href="https://t.me/tteiio" target="_blank">
        <i class="fab fa-telegram-plane"></i>
        اذهب للقناة
      </a>
      <br>
      <button onclick="closeModal()" class="download-btn" style="margin-top: 1rem;">
